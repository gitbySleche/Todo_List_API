...
cursor.execute('CREATE TABLE IF NOT EXISTS todo(id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, title TEXT NOT NULL, description TEXT, FOREIGN KEY (users_id) REFERENCES users(id)')
